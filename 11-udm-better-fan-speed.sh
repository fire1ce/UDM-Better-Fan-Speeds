...
UBIOS_CPU_MINIMAL_DUTY_FAN_PWM='0'   # default 128, this sets the minimal RPM for the CPU fan
...
UBIOS_CPU_MINIMAL_TEMP='35000' # default 45000, 45 degree celsius
UBIOS_HDD_MINIMAL_TEMP='45000' # default 90000, 90 degree celsius
