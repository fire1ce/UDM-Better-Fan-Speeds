...
curl -O https://raw.githubusercontent.com/fire1ce/UDM-Better-Fan-Speeds/main/11-udm-better-fan-speed.sh
...
ehco "You can eddit the fan-speed settings in /mnt/data/on_boot.d/11-udm-better-fan-speed.sh \n"
